#!/usr/bin/env python3
"""
Unified Orderbook Streamer with Korean & Global Exchanges
Streams to QuestDB with proper schema for cross-exchange analysis
"""
...
async def questdb_consumer(batch_q: asyncio.Queue, 
    ...
    - Timestamp: event_ts in nanoseconds
    """
...
async def main():
    ...
    print("=" * 60)
    print("Unified Orderbook Streamer Started")
    print("=" * 60)
